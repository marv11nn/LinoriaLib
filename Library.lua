...
local Library = {
    ...
    AccentColor = Color3.fromRGB(229,8,8);
...
local function IsValidClick(Input)
    return Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch
end

local function IsValidRightClick(Input)
    return Input.UserInputType == Enum.UserInputType.MouseButton2
end

local function IsInputPressed()
    return InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or 
           (InputService.TouchEnabled and #InputService:GetTouchDeviceIds() > 0)
end
...
function Library:MakeDraggable(Instance, Cutoff)
    ...
    Instance.InputBegan:Connect(function(Input)
        if IsValidClick(Input) then  -- CHANGED
            ...
            while IsInputPressed() do  -- CHANGED
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        SatVibMap.InputBegan:Connect(function(Input)
            if IsValidClick(Input) then
                while IsInputPressed() do
        ...
        DisplayFrame.InputBegan:Connect(function(Input)
            if IsValidClick(Input) and not Library:MouseIsOverOpenedFrame() then
        ...
        function KeyPicker:GetState()
            ...
            elseif KeyPicker.Mode == 'Hold' then
                ...
                if Key == 'MB1' or Key == 'MB2' then
                    return Key == 'MB1' and IsInputPressed()
        ...
        PickOuter.InputBegan:Connect(function(Input)
            if IsValidClick(Input) and not Library:MouseIsOverOpenedFrame() then
                ...
                Event = InputService.InputBegan:Connect(function(Input)
                    ...
                    elseif IsValidClick(Input) then
                        Key = 'MB1';
        ...
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
            if (not Picking) then
                if KeyPicker.Mode == 'Toggle' then
                    ...
                    if Key == 'MB1' or Key == 'MB2' then
                        if Key == 'MB1' and IsValidClick(Input)
